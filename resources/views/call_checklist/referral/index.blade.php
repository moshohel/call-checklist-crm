          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="{{ route('referral.edit', [$referral->unique_id, $referral->id]) }}"
                  class="btn btn-info btn-default">Edit</a>
                <a href="{{ route('referral.showInfo', [$referral->unique_id, $referral->id]) }}"
                  class="btn btn-info btn-default">Assign Counselor</a>
              </td>

...
@section('content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-tags"></i> <a href="{{ route('call_checklist.shojon.supervisor.dashboard') }}">{{ $pageTitle }}</span></a>
            </h1>
        </div>
    </div>
                ...
                <div class="tile-body">
                    <div>
                        ...
                        <!--    <span class="pull-right hidden-print" style="margin-left: 5px">
                            ...
                            <form action="{{ route('call_checklist.shojon.supervisor.dashboard') }}" method="get" enctype="multipart/form-data" id="search">
                              @csrf
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="card widget-block p-4 rounded bg-danger ">
                                <div class="card-block">
                                    ...
                                    <p class="py-2">Unique(Inbound) Call</p>
                                </div>

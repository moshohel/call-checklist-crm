...
<div class="form-group">
    ...
    <div class="form-control">
        <div class="form-control">
            ...
            <input type="text" class="form-control" name="examination_appearance" placeholder="Appearance Explain">
        </div>
        <div class="form-control">
            <label class="control-label">Behavior (please explain)</label>
            <input type="text" class="form-control" name="examination_behavior" placeholder="Behavior Explain">
        </div>
        <div class="form-control">
            <label class="control-label">Speech (please explain)</label>
            <input type="text" class="form-control" name="examination_speech" placeholder="Speech Explain">
        </div>
        <div class="form-control">
            <label class="control-label">Mood and affect (please explain)</label>
            <input type="text" class="form-control" name="examination_affect" placeholder="Mood and Affect Explain">
        </div>
        <div class="form-control">
            <label class="control-label">Thought (please explain)</label>
            <input type="text" class="form-control" name="examination_thought" placeholder="Thought Explain">
        </div>
        <div class="form-control">
            <label class="control-label">Perception (please explain)</label>
            <input type="text" class="form-control" name="examination_perception" placeholder="Perception Explain">
        </div>
        <div class="form-control">
            <label class="control-label">Cognition (please explain)</label>
            <input type="text" class="form-control" name="examination_cognition" placeholder="Cognition Explain">
        </div>
        <div class="form-control">
            <label class="control-label">Insight & Judgement (please explain)</label>
            <input type="text" class="form-control" name="examination_judgement" placeholder="Judgement Explain">
        </div>
    </div>
</div>

                        ...
                        <div class="col-md-12">
                            <div class="row g-2">
                                ...
                                <div class="col-md-7">
                                    ...
                                    {{-- <label for="validationCustom01" class="form-label"><b>{{ $data->distress
                                            }}</b></label><br> --}}
                                    {{-- <label for="validationCustom01" class="form-label"><b>{{ $data->WHO }}
                                            %</b></label><br> --}}
                                </div>
                            </div><br>
                        </div>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="col-md-12">
                            <div class="row g-1">
                                <div class="col-md-12">
                                    <label for="validationCustom01" class="form-label">Client’s Expectation from
                                        therapy:</label><br>
                                    <label class="form-control">
                                        {{-- <label for="validationCustom01" style="color:black;"
                                            class="form-label"><b>{{ $data->therapy }}</b></label> --}}
                                    </label>
                                </div>
                            </div>
                            <hr>
                            <div class="col-md-12">
                                <table class="table table-bordered border-primary" id="dynamic_field_Treatment">
                                    ...
                                    {{-- <tbody>
                                        @if ($data->predisposing != "" && $data->precipitatory != "" &&
                                        $data->perpetuating != "" && $data->protective != "" )
                            ...
                            <div class="row g-1">
                                <div class="col-md-12">
                                    ...
                                    <label class="form-control">
                                        {{-- <label for="validationCustom01" style="color:black;"
                                            class="form-label"><b>{{ $data->short_term }}</b></label> --}}
                                    </label>
                                </div>
                            </div>
                            <hr>
                            <div class="row g-1">
                                <div class="col-md-12">
                                    ...
                                    <label class="form-control">
                                        {{-- <label for="validationCustom01" style="color:black;"
                                            class="form-label"><b>{{ $data->long_term }}</b></label> --}}
                                    </label>
                                </div>
                            </div>
                            <hr>
                            <div class="row g-1">
                                <div class="col-md-12">
                                    ...
                                    <label class="form-control">
                                        {{-- <label for="validationCustom01" style="color:black;"
                                            class="form-label"><b>{{ $data->intervention }}</b></label> --}}
                                    </label>
                                </div>
                            </div>
                            <hr>
                            <div class="row g-1">
                                <div class="col-md-12">
                                    ...
                                    <label class="form-control">
                                        {{-- <label for="validationCustom01" style="color:black;"
                                            class="form-label"><b>{{ $data->homework }}</b></label> --}}
                                    </label>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row g-1">
                                <div class="col-md-12">
                                    <label for="validationCustom01" class="form-label">Schedule next
                                        session:</label><br>
                                    <label class="form-control">
                                        <label for="validationCustom01" style="color:black;"
                                            class="form-label"><b>session_date</b></label>
                                    </label>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="col-md-12">
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <label for="validationCustom01" class="form-label"><b>{{
                                                $data->service_providers_di }}</b></label><br>
                                        <label for="validationCustom01" class="form-label"><b>{{
                                                $data->time_call_started }}</b></label><br>
                                        <label for="validationCustom01" class="form-label"><b>{{ $data->time_call_ended
                                                }}</b></label><br>
                                        <label for="validationCustom01" class="form-label"><b>{{ $data->duration
                                                }}</b></label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row g-1">
                                    <div class="col-md-12">
                                        ...
                                        <label class="form-control">
                                            <label for="validationCustom01" style="color:black;"
                                                class="form-label"><b>{{ $data->problem_history }}</b></label>
                                        </label>
                                    </div>
                                </div>
                                <hr>
                                <div class="row g-1">
                                    <div class="col-md-12">
                                        ...
                                        <label class="form-control">
                                            <label for="validationCustom01" style="color:black;"
                                                class="form-label"><b>{{ $data->family_history }}</b></label>
                                        </label>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="row g-2">
                                    <div class="col-md-5">
                                        <label for="validationCustom01" class="form-label">Present Continuation of
                                            Psychiatric Medication:</label>
                                    </div>
                                    <div class="col-md-7">
                                        {{-- <label for="validationCustom01" class="form-label"><b>{{
                                                $data->psychiatric_medication }}</b></label> --}}
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                ...
                                <div class="row g-1">
                                    <div class="col-md-12">
                                        <label for="validationCustom01" class="form-label">Mention the name of medicine
                                            if any:</label><br>
                                        <label class="form-control">
                                            <label for="validationCustom01" style="color:black;"
                                                class="form-label"><b>{{ $data->name_of_medicine }}</b></label>
                                        </label>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="validationCustom01" class="form-label">Psychometric Tool
                                            Name:</label><br>
                                        <ul>
                                ...
                                <div class="row g-1">
                                    <div class="col-md-12">
                                        <label for="validationCustom01" class="form-label">Psychometric Tool score
                                        </label><br>
                                        <label class="form-control">
                                            {{-- <label for="validationCustom01" style="color:black;"
                                                class="form-label"><b>{{ $data->score }}</b></label> --}}
                                        </label>
                                    </div>
                                </div>
                                <hr>

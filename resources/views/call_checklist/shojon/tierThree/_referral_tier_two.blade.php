<div class="modal fade" id="Referral_tier_threeModal" tabindex="-1" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-4">
              ...
              @else
              <input type="text" class="form-control" required readonly name="client_name"
          ...
          <div class="row g-2">
            <div class="col-md-6">
              ...
              @else
              <input type="number" class="form-control" required readonly name="phone_number"
          ...
          <div class="row g-2">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" required name="reason_for_therapy"
                placeholder="Reason for therapy">
            </div>
            <div class="col-md-6">
              <label for="validationCustom01" class="form-label">Preferred time for session:</label>
              <input type="datetime-local" class="form-control" required name="preferred_time"

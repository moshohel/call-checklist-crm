        ...
        <div class="tile-body">
          ...
          <div class="row g-4">
            <div class="col-md-3">
              ...
              <input type="number" class="form-control" min="7" max="15" readonly name="phone_number"
            ...
            <div class="col-md-3">
              <div class="form-group">
                @php $types = ['0-12','13-19','20-30','30-40','40-65','65+','Don’t know.','Don’t want to share'];
                @endphp
          ...
          <div class="row g-4">
            <div class="col-md-3">
              <div class="form-group">
                @php $types = ['Upper', 'Upper Middle Class', 'Middle Class', 'Lower Middle Class', 'Upper Lower Class',
                'Lower Class']; @endphp
            ...
            <div class="col-md-3">
              <div class="form-group">
                @php $types = ['Received Service','Information related call','Inappropriate','Silent call','Hang up'];
                @endphp
            ...
            <div class="col-md-3">
              <div class="form-group">
                @php $types = ['First time','Regular Caller','Follow Up','Continuation of previous call','Don’t know'];
                @endphp
          ...
          <div class="row g-3">
            <div class="col-md-4">
              <div class="form-group">
                ...
                @php $types = ['Student', 'Job holder', 'Businessperson', 'Housewife', 'Unemployed','self employed',
                'Retired', 'Could not tell']; @endphp
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="validationCustom01" class="form-label">2.Where/how did the Client hear about SHOJON</label>
                @php $types = ['Search engine','KPR', 'Social Media', 'Word of mouth', 'Referred by professional',
                'SUDIN', 'SF Microfinance','Radio','TV','Print Media','Oboyob','Lamb Hospital','Incidin BD','Don’t
                know.']; @endphp
                <div class="form-control">
                  @foreach($types as $item)
                  @if((old('occupation') == $item))
                  ...
                  @else
                  <input type="radio" name="about_shojon" value="{{ $item }}" onclick="Showabout_shojonBox()" />
                  @endif
                  {{ $item }}
                  <br>
                  @endforeach
                  <input type="radio" id="chkabout_shojon" name="about_shojon" onclick="Showabout_shojonBox()" />
          ...
          <div class="row g-3">
            <div class="col-md-4">
              <div class="form-group">
                <label for="validationCustom01" class="form-label">4.Primary Reason for Calling (CHOOSE ONLY
                  ONE)</label>
                @php $types = ['COVID19 related Issues', 'Mental Illness', 'Substance Abuse', 'Family/Relationship
                Issues', 'Health/Physical Concerns', 'Financial Concerns', 'Immediate Emotional Crisis','Suicidal
                Feelings','Domestic Abuse','Child Abuse','Discrimination due to gender','Mental Health Related
                Symptoms','Discrimination due to minority status','Education','Bereavement','Work related
                stress','Disability','Anger','Parenting issue','Don’t know']; @endphp
                <div class="form-control">
                  @foreach($types as $item)
                  ...
                  @else
                  <input type="radio" name="primary_reason" value="{{ $item }}" onclick="Showprimary_reasonBox()" />
                  @endif
                  {{ $item }}
                  <br>
                  @endforeach
                  <input type="radio" id="chkprimary_reason" name="primary_reason" onclick="Showprimary_reasonBox()" />
                  Other, comment (please explain)
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="validationCustom01" class="form-label">5.Secondary reason (Multiple select)</label>
                @php $types = ['COVID19 related Issues', 'Mental Illness', 'Substance Abuse', 'Family/Relationship
                Issues', 'Health/Physical Concerns', 'Financial Concerns', 'Immediate Emotional Crisis','Suicidal
                Feelings','Mental Health Related Symptoms','Domestic Abuse','Child Abuse','Discrimination due to
                gender','Discrimination due to minority status','Education','Bereavement','Work related
                stress','Disability','Anger','Parenting issue','Don’t know','Not applicable']; @endphp
                <div class="form-control">
                  @foreach($types as $item)
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label class="control-label" for="distress_rating"><b>6.Does the client have any mental illness
                    diagnosis</b></label>
                @php $types = ['Major Depressive Disorder', 'Anxiety Disorder', 'Panic Disorder','Obsessive Compulsive
                Disorder','Social Anxiety Disorder','Insomnia','Schizophrenia','Bipolar Disorder ','Personality
                Disorder','Autism spectrum disorder','Attention deficit hyperactivity disorder','Learning disorder
                (LD)','Phobia','Post-traumatic stress disorder (PTSD)','Substance Abuse Disorder','Sexual
                disorder','Gender Identity disorder','Conversion disorder','Conduct disorder','No']; @endphp
                <div class="form-control">
                  @foreach($types as $item)
          ...
          <div class="row g-3">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" id="ghq" name="ghq" value="{{old('ghq','Incomplete')}}" style="text-align:center;"
                  readonly>
              </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-5">
              <div class="form-group">
                @php $types = ['Explicitly angry/upset and said something negative about call experience','Was not
                explicitly angry/upset, but you can tell they were dissatisfied with the call','Neutral about call
                experience: not positive or negative','Did not explicitly say anything about feeling better, but you can
                tell','They are calmer, less anxious, no longer crying, etc','Explicitly said “thank you” or that they
                were feeling better and was','Obviously much better at end of call','Was VERY HAPPY with call
                experience, multiple expressions of gratitude/thanks','Not applicable']; @endphp
                <label for="validationCustom01" class="form-label"><b>9.How effective the session went for the
                    client</b></label>
                ...
                <div class="form-control">
                  ...
                  <label class="form-control">
                    <label class="control-label">
                      <input type="radio" id="chkSHOJONTierTwo" class="TierTwoChe" name="Speech"
                        onclick="ShowSHOJONTierTwoBox()" />
                  ...
                  <label class="form-control">
                    <label class="control-label">
                      <input type="radio" id="chkSHOJONTierThree" class="TierThreeChe" name="Speech"
                        onclick="ShowSHOJONTierThreeBox()" />
          ...
          <div class="form-group" id="messageBox" style="display: none">
            <select name="sms_switch" type="text" class="form-control" id="sms_type" list="sms_types"
              ...
              <datalist id="sms_types">
                ...
                <option value="health_hotline" <?php if (old('sms_switch')=='health_hotline' ) echo "selected" ?> >
                  Health Hotline
                </option>

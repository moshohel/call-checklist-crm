                            ...
                            <div class="row g-2">
                                <div class="col-md-5">
                                    ...
                                    <label for="validationCustom01" class="form-label">Socio-economic
                                        Status:</label><br>
                                    <label for="validationCustom01" class="form-label">Where/how did the Client hear
                                        about SHOJON:</label><br>
                                    ...
                                    <label for="validationCustom01" class="form-label">Distress Rating Post:
                                    </label><br>
                                ...
                                <div class="col-md-7">
                                    ...
                                    <label for="validationCustom01" class="form-label"><b>{{ $data->hear_about_shojon
                                            }}</b></label><br><br>
                                    <label for="validationCustom01" class="form-label"><b>{{ $data->call_Type
                                            }}</b></label><br>
                                    <label for="validationCustom01" class="form-label"><b>{{ $data->caller
                                            }}</b></label><br>
                                    <label for="validationCustom01" class="form-label"><b>{{ $data->distress
                                            }}</b></label><br>
                                    <label for="validationCustom01" class="form-label"><b>{{ $data->distress_post
                                            }}</b></label><br>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="validationCustom01" class="form-label">Primary Reason for Calling
                                        </label><br>
                                        <ul>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <label for="validationCustom01" class="form-label">Does the client have any
                                            mental illness diagnosis?</label><br>
                                        <ul>
                                            @if ($check_item != "")
                                            @foreach($check_item as $info)
                                            <li><b>{{$info}}</b></li>
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-7">
                                        <label for="validationCustom01"
                                            class="form-label"><b>{{$data->suicidal_risk}}</b></label>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="validationCustom01" class="form-label">How effective the session
                                            went for the client? (Client rating of effectiveness)</label><br>
                                        <ul>
                                            @if($data->effective !="")
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="validationCustom01" class="form-label"><b>Call
                                                Ddescription</b></label><br>
                                        <ul>
...
<script type="text/javascript">
    $('#sampleTablereferral').DataTable();
</script>
<script type="text/javascript">
    $('#sampleTabletarmination').DataTable();
</script>
@endpush
...
<script>
    $(document).ready(function(){
        ...
        $.ajax({
            type: "get",
            url: "{{ env('BASE_URL') }}"+"/call-checklist/shojon/referral_table",

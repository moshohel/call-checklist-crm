        ...
        <h5 class="modal-title" id="exampleModalLabel">Referral Form </h5>
          ...
          <form id="_referral_tier_two_form">
            ...
            <div class="modal-body">
              ...
              <input type="text" class="form-control" required readonly name="referral_from" value="Shojon Tier 2">
             </div>
             </div><hr>
             <div class="row g-3">
              <div class="col-md-4">
             ...
             <div class="row g-2">
              ...
              <input type="number" class="form-control" required name="phone_number" value="{{$newPatient->phone_number}}" readonly>
              </div>
              <div class="col-md-6">

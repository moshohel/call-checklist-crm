...
<div class="card card-default">
    ...
    <div class="card-body">
        ...
        @if( (auth()->user()->user_group == "Supervisor") || (auth()->user()->user_group == "Therapist") || (auth()->user()->user_group == "Psychiatrist"))
        <div class="row">
            {{-- <div class="col">
                <a href="{{ route('patient.edit', $rescheduleOrCancelation->id) }}" class='btn btn-info'>Edit</a>
            </div> --}}
            <div class="col">
                <a href="#deleteModal{{ $rescheduleOrCancelation->id }}" data-toggle="modal" class="btn btn-danger">Cancel the Session</a>
            </div>
            <div class="col">
...
<div class="card card-default">
    <div class="card-body">
        <form id="_referral_form" action="{{ route("session.update", [$rescheduleOrCancelation->unique_id, $rescheduleOrCancelation->therapist_or_psychiatrist_user_id]) }}" method="post" enctype="multipart/form-data" style="display: none">
            @csrf
            <div class="card-header card-header-border-bottom">
            ...
            <div class="row">
                <div class="form-group col-3">
                    ...
                    @if(isset($rescheduleOrCancelation->client_name)) 
                            <input type="text" class="form-control" name="client_name" readonly value="{{ $rescheduleOrCancelation->client_name }}">
                        @endif
                </div>
                ...
                <div class="form-group col-3">
                    ...
                    @if(isset($rescheduleOrCancelation->unique_id)) 
                            <input type="text" class="form-control" name="client_id" readonly value="{{ $rescheduleOrCancelation->unique_id }}">
                    @endif
                </div>
                ...
                <div class="form-group col-3">
                    ...
                    @if(isset($rescheduleOrCancelation->phone_number)) 
                        <input type="number" class="form-control" name="phone_number" value="{{ $rescheduleOrCancelation->phone_number }}">
                    @endif
                </div>

        ...
        <form method="POST" action="{{ route('session.rescheduleOrCancelationStore') }}" enctype="multipart/form-data">
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="request_type" value="Cancelation"
                                        required>Cancelation
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="request_type" value="Reshedule"
                                        required>Reshedule
                                </label>
                            </div>
                ...
                {{-- <div class="form-group col-md-3 col-sm-12">
                    ...
                    <input type="text" name="client_name" class="form-control" id="exampleFormControlInput1" required>
                </div> --}}
                ...
                <div class="form-group col-md-3 col-sm-12">
                    <label for="exampleFormControlInput2">Client Id <span class="red-star">★</span></label>
                    <input type="text" name="unique_id" class="form-control" id="exampleFormControlInput2" required>
                </div>

                <div class="form-group col-6">
                    <label for="exampleFormControlSelect3">Consultent Name (Must) <span
                            class="red-star">★</span></label>
                    <select class="form-control" name="therapist_or_psychiatrist_user_id" id="exampleFormControlSelect3"
                        required>
                ...
                {{-- <div class="form-group col-md-4 col-sm-12">
                    ...
                    <input type="time" name="previous_session_time" class="form-control" id="exampleFormControlInput1">
                </div>

                <div class="form-group col-md-4 col-sm-12">
                    <label for="exampleFormControlInput1">Previous Session Date</label>
                    <input type="date" name="previous_session_date" class="form-control" id="exampleFormControlInput1">
                </div> --}}

                <div class="form-group col-md-3 col-sm-12">
                    <label for="exampleFormControlInput1">Requested Session Time</label>
                    <input type="time" name="requested_session_time" class="form-control" id="exampleFormControlInput1">
                </div>

                <div class="form-group col-md-3 col-sm-12">
                    <label for="exampleFormControlInput1">Requested Session Date</label>
                    <input type="date" name="requested_session_date" class="form-control" id="exampleFormControlInput1">
                </div>

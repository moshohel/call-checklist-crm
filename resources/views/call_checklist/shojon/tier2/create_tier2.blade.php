    ...
    <div class="col-md-12 mx-auto">
        <div class="tile">
            ...
            <form id="myForm" action="{{ route('call_checklist.shojontier2.store') }}" method="POST" role="form"
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="phone_number" id="phone_number" value="1">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                @php $types = ['0-12','13-19', '20-30', '31-40', '41-65', '65+', 'Do not know', 'Do not
                                want to share']; @endphp
                ...
                <div class="form-group">
                    <label class="control-label" for="Educational_Qualification"><b> Educational Qualification:
                            (mandatory single select):</b></label>
                    @php $types = ['Pre-primary(Jr/Sr KG or equivalent)', 'Primary (1st-5th)', 'Secondary (5th-SSC)',
                    'Higher Secondary ( 11th- HSC)', 'Graduate (degree and Hons)', 'Post-Graduate and above','Never been
                    to school','Don’t know','Other']; @endphp
                ...
                <div class="form-group">
                    ...
                    @php $types = ['Single', 'Married', 'Divorced', 'Separated', 'Don’t know', 'Don’t want to share'];
                    @endphp
                ...
                <div class="form-group">
                    ...
                    {{-- <div class="col-md-auto"> --}}
                        ...
                        {{-- <input class="form-control @error('distress_rating') is-invalid @enderror" type="number"
                            name="distress_rating" min="1" max="10" value="0"> --}}

                        <select name="distress_rating"
                            class="form-control @error('distress_rating') is-invalid @enderror">
                            <option value="">Select a Value</option>
                            @for ($i = 0; $i < 11; $i++) @if( old('distress_rating') && (old('distress_rating')==$i))
                ...
                <div class="form-group">
                    ...
                    <a href="#" class="btn btn-info btn-sm edit" data-id="#" data-toggle="modal"
                        data-target="#editModal">Qiestionniare</a>
                ...
                <div class="form-group">
                    <label class="control-label" for="Problem_duration"><b>Problem duration: (mandatory single
                            select)</b></label>
                    @php $types = ['<1 month', '1 to 3 months' , '4 to 6 months ' , '6 to 12 month '
                        ...
                        know','Other']; @endphp <select name="Problem_duration" list="Problem_duration"
                ...
                <div class="form-group">
                    <label class="control-label" for="Problem_duration"><b> Illness/ problem history (short): (text
                            filled)</b></label>
                ...
                <div class="form-group">
                    <label class="control-label" for="Problem_duration"><b>Family History (short): (text
                            filled)</b></label>
                ...
                <div class="form-group">
                    <label class="control-label" for="suicidal_risk"><b>Does the client have suicidal Ideation? (Single
                            select) </b></label>
                ...
                <div class="form-group">
                    <label class="control-label" for="self_harm_history"><b>Does the client have any self-harm history?
                            (Single select)</b></label>
                ...
                <div class="form-group">
                    <label class="control-label" for="mental_illness_diagnosis"><b>Previous psychiatric diagnosis?
                            (Multiple select)
                            ...
                            Disorder','Insomnia','Schizophrenia','Bipolar Disorder ','Personality Disorder','Autism
                            spectrum disorder','Attention deficit hyperactivity disorder','Learning disorder
                            (LD)','Phobia','Post-traumatic stress disorder (PTSD)','Substance Abuse Disorder','Sexual
                            disorder','Gender Identity disorder','Conversion disorder','Conduct','No']; @endphp
                            <div class="form-control @error('mental_illness_diagnosis') is-invalid @enderror">
                                <label>
                                    ...
                                    <label>
                                        ...
                                        <input type="hidden" name="mental_illness_diagnosis[]" value=""
                                            checked="checked">
                                    </label>
                ...
                <div class="form-group">
                    <label class="control-label" for="PresentCotinuation"><b>Present Continuation of Psychiatric
                            Medication: (mandatory single select)
                    </label><br>
                ...
                <div class="form-group">
                    <label class="control-label" for="Physical_Concern_history"><b>Physical Concern history: (multiple
                            select)
                    </label>
                    @php $types = ['Diabetes','Hypertension','Chronic pain','Asthma','Hormonal issues','Life threatening
                    disease','Obesity']; @endphp
                ...
                <div class="form-group">
                    <label class="control-label" for="current_differential_diagnosis"><b>Current Differential Diagnosis:
                            (Mandatory multiple select)
                            @php $types = ['Major Depressive Disorder', 'Anxiety Disorder', 'Panic Disorder','Obsessive
                            ...
                            (LD)','Dementia','Alzheimer','Phobia','Post-traumatic stress disorder (PTSD)','Substance
                            Abuse Disorder','Sexual disorder','Gender Identity disorder','Conversion
                            ...
                            <div class="form-control @error('current_differential_diagnosis') is-invalid @enderror">
                                <label>
                                    ...
                                    <label>
                                        ...
                                        <input type="checkbox" name="current_differential_diagnosis[]"
                                            value="{{ $item}}" onclick="ShowCurrentDiagnosis()" checked="checked" />

                                        @else
                                        <input type="checkbox" name="current_differential_diagnosis[]"
                                            value="{{ $item}}" onclick="ShowCurrentDiagnosis()" />
                                        @endif
                                        {{ $item }}
                                        <br>
                                        @endforeach
                ...
                <div class="form-group">
                    <label class="control-label" for="PsychometricToolscore"><b>Psychometric Tool score &
                            Interpretation:
                    </label><br>
                    @php $types = ['Depression scale','Anxiety','Social Interaction Anxiety scale ','Obsessive-
                    compulsive disorder ','Beck hopelessness scale','Cognitive distortion scale','Depression, Anxiety,
                    stress scale','Somatic complaint scale','Event'];@endphp
                ...
                <div class="form-group">
                    <label class="control-label" for="Problem_duration"><b> Client’s Expectation from
                            therapy:</b></label>

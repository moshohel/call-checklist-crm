    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6 col-xl-4 card-body text-center" style="height: 15ch;">
                <a href="{{ route('patient.create',$number) }}" class="btn btn-primary text-center"
                    style="width: 100%; height: 100%;">
                    <p style="margin-top: 1rem">New Client</p>
                </a>
            </div>
            <div class="col-md-6 col-xl-4 card-body text-center " style="height: 15ch;">
                <a href="{{ route('patients') }}" class="btn btn-primary text-center"
                    style="width: 100%; height: 100%;">
                    <p style="margin-top: 1rem">Existing Client</p>
                </a>
            </div>
            <div class="col-md-6 col-xl-4 card-body text-center" style="height: 15ch;">
                <a href="{{ route('session.rescheduleOrCancelationForm', $number) }}" style="width: 100%; height: 100%;"
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xl-4 card-body text-center" style="height: 15ch;">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#Cilent_call_Modal"
                    style="width: 100%; height: 100%;">Silent Call</button>
            </div>
            <div class="col-md-6 col-xl-4 card-body text-center" style="height: 15ch;"
                style="width: 100%; height: 100%;">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#Reassign_reaquest_Modal"
                    style="width: 100%; height: 100%;">Reassign Request</button>
            </div>
            <div class="col-md-6 col-xl-4 card-body" style="height: 15ch;">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#TerminationModal_pop"
                    style="width: 100%; height: 100%;">Service Termination</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="Cilent_call_Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
...
<div class="modal fade" id="Reassign_reaquest_Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="_reassign_request_form">
                    ...
                    <div class="form-row">
                        <div class="col">
                            <label for="unique_id" class="form-label"><b>Client ID</b> <span
                                    style="color: red;">*</span></label>
                            <input type="text" class="form-control" maxlength="9" minlength="9" required
                                name="unique_id" placeholder="SHOXXXXXX">
                        </div>
                        <div class="col">
                            <label for="phone_number" class="form-label"><b>Phone Number</b> <span
                                    style="color: red;">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="reason_for_reassing" class="form-label"><b>Reason for Reassing</b> <span
                                style="color: red;">*</span></label>
                        <textarea class="form-control" name="reason_for_reassing" required id="reason_for_reassing"
                            rows="3"></textarea>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="TerminationModal_pop" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="row g-4">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" readonly name="project_name" value="SHOJON"
                                placeholder="Project name">
                        </div>
                        <input type="hidden" name="flag" value="tier2">
                        <div class="col-md-3">
                            <label for="validationCustom01" class="form-label">Counselor name:</label>
                            <input type="text" class="form-control" readonly name="Counselor_name"
                                value="{{ auth()->user()->full_name }}" placeholder="Counselor name">
                        </div>
                        <div class="col-md-3">
                            ...
                            @else
                            <input type="text" class="form-control" readonly value="{{$newPatient->name}}"
                    ...
                    <div class="row g-2">
                        <div class="col-md-8">
                            @php $types = ['The planned treatment was completed','The client refused to receive or
                            participate in services','The client was unable to afford continued or didn’t pay fees on
                            time ','Client migrate','There was little or no progress in treatment','The counselor
                            migrate','The counselor could not be able to continue the therapy for any reason','The
                            client needs services that are not available here, so was referred']; @endphp
                            <label for="validationCustom01" class="form-label">Main reason for termination (mandatory
                                single select) </label>
                            <div class="form-control ">
                                ...
                                <span id="terminationBox" style="display: none;">
                                    <input class="form-control" type="text" name="other_termination"
                                        placeholder="Explain" />
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <label class="form-control">
                            ...
                            <table class="table table-bordered border-primary" id="dynamic_field_Treatment">
                                ...
                                <tbody>
                                    <tr>
                                        <td><input type="text" name="Scheduled[]" placeholder="Scheduled Factor"
                                                class="form-control name_list" /></td>
                                        <td><input type="text" name="Attended[]" placeholder="Attended"
                                                class="form-control name_list" /></td>
                                        <td><input type="text" name="Cancelled[]" placeholder="Cancelled"
                                                class="form-control name_list" /></td>
                                        <td><input type="text" name="notAttend[]" placeholder="Not attend"
                                                class="form-control name_list" /></td>
                                        <td><button type="button" name="addmore" id="addmore_Treatment"
                    ...
                    <div class="form-group">
                        ...
                        <label class="form-control">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="Distress_pre"
                                        placeholder="Distress Pre">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="Distress_post"
                                        placeholder="Distress Post">
                                </div>
                            </div><br>
                            <div class="row g-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="Wellbeing_pre"
                                        placeholder="Wellbeing scale Pre">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="Wellbeing_post"
                                        placeholder="Wellbeing scale Post">
                                </div>
                            </div><br>
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <label for="validationCustom01" class="form-label">Psychological tools
                                        rating:</label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="Psychological_pre"
                                        placeholder="Psychological tools Pre">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="Psychological_post"
                                        placeholder="Psychological tools Post">
                                </div>
                            </div>
                        </label>
                    </div>
...
<script>
    $(document).ready(function () {
        $('#search').on('keyup', function(){
            ...
            $.ajax({
                type: "get",
                url: "{{ env('BASE_URL') }}"+"/patient/livesearch",
                data: {Search:value},
...
<script>
    $(document).ready(function(){
        ...
        $.ajax({
            type: "get",
            url: "{{ env('BASE_URL') }}"+"/patient/cilent_call_Number",
...
<script type="text/javascript">
    $('#liveSearch_table').DataTable();
</script>
<script type="text/javascript">
    $('#cilentCallTable').DataTable();
</script>
@endpush
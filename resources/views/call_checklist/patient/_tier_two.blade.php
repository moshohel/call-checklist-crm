<div id="accordion" class="accordion">
    ...
    <?php
        ...
        ?>
    <div class="card">
        <div class="card-header collapsible-title" id="headingTwo" style="background-color: #f2f2f2;">
            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo{{ $query->id }}"
                aria-expanded="false" aria-controls="collapseTwo{{ $query->id }}">
                Tier Two Service Number - {{ $i++ }}
            </button>
        </div>
        <div id="collapseTwo{{ $query->id}}" class="collapse" aria-labelledby="headingTwo{{ $query->id }}"

<div class="modal fade" id="TerminationModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script>
	$(document).ready(function(){      
		var postURL = "<?php echo url('multipulField_Treatment'); ?>";
		var i=1;  

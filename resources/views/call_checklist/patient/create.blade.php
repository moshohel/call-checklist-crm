            ...
            <form action="{{ route('patient.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="number" name="phone_number" class="form-control" readonly value="{{$number}}">
                    </div>

                    <div class="form-group col-6">
                        <label class="control-label" for="sex"><b>Sex: <span class="required">*</span></b></label>
                        @php $types = ['Male','Female','LGBTQ','Others']; @endphp
                        <select name="sex" id="sex" list="sex_list" required
                    ...
                    <div class="form-group col-6">
                        ...
                        share']; @endphp
                        <select name="age" id="age" list="age_list" required
                    ...
                    <div class="form-group col-6">
                        <label class="control-label" for="district"><b>Location: <span
                    ...
                    <div class="form-group col-6">
                        ...
                        <select name="socio_economic_status" list="socio_economic_status_list" required
